console.log("Browser Image Processor SW Started (S3 Upload v2.1 - Secured).");

// --- Configuration ---
const GET_UPLOAD_URL_ENDPOINT = "<UPOAD_URL_LAMBDA>"; // e.g., https://<...>/get-upload-url
// !!! REPLACE with HttpApiTriggerUrl Output !!!
const TRIGGER_RELAY_ENDPOINT = "<TRIGGER_URL_LAMBDA>"; 
// !!! ADD YOUR API KEY VALUE HERE - Acquired After CFN Deploy & Manual Retrieval !!!
const API_KEY_VALUE = "<WSS_SECRET_API_KEY>";
...
console.log("Browser Image Processor Background SW Ready (Chrome S3 v2.1 - Secured).");